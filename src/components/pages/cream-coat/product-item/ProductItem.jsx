  ...
  return (
    <div className="product__item">
      ...
      <div className="product__description">
        <h4 ref={refTitle} className="product__description__title">
          Синее пальто
        </h4>
        ...
        <div className="dropdown">
          <select ref={refSize} className="dropdown__btn">
            <option value="XXS" className="dropdown__list__item">
              XXS
            </option>
            <option value="XS" className="dropdown__list__item">
              XS
            </option>
            <option value="S" className="dropdown__list__item">
              S
            </option>
            <option value="M" className="dropdown__list__item">
              M
            </option>
            <option value="L" className="dropdown__list__item">
              L
            </option>
          </select>
        </div>
        <div className="product__text hidden">Цвет: Белый</div>
        <div className="product__text hidden">Цвет: Синий</div>
        <div className="product__text" data-tab-content id="tab-3">
          Цвет: Кофе с молоком меланж
        </div>
        <div className="product__form">
          <div onClick={productAddBasket} className="product__form__input">
            В КОРЗИНУ
          </div>
        </div>
        <div className="product__description__subtitle">Подробности</div>
        <div className="product__description__info">Обмеры и описание</div>
